  ...
  static TextTheme _buildTextTheme(TextTheme base) {
    return GoogleFonts.interTextTheme(base).copyWith(
      displayLarge: GoogleFonts.inter(
        fontSize: 36, fontWeight: FontWeight.bold, height: 1.1), // H1
      headlineMedium: GoogleFonts.inter(
        fontSize: 30, fontWeight: FontWeight.bold, height: 1.2), // H2
      headlineSmall: GoogleFonts.inter(
        fontSize: 24, fontWeight: FontWeight.w600, height: 1.3), // H3
      bodyLarge: GoogleFonts.inter(fontSize: 16, height: 1.5),   // Body
      bodyMedium: GoogleFonts.inter(fontSize: 14, height: 1.5),  // Caption/Button
    );
  }
